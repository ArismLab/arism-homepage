...
class MyDocument extends Document {
	render() {
		return (
			<Html lang="en" className="bg-dark-background scroll-smooth ">
				<Head>
					<link
						rel="icon"
						type="image/png"
					...
					<script
						async
						src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3677034382401707"
